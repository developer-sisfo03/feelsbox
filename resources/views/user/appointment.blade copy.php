...
<body>
    ...
    <!-- ======= Hero Section ======= -->
    <section class="dark-bg" id="hero-appointment"> -->
        <div class="container" data-aos="fade-up">
            <div class="text-light d-flex flex-column h-100 justify-content-center text-center">
                <h1>
                    Appointment
                </h1>
                <p>
                    lakukan registrasi untuk mengisi jadwal konsultasi
                </p>
            </div>
        </div>
    </section>
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <form action="forms/appointment.php" method="post" role="form" class="php-email-form"
                    ...
                    <div class="text-center mt-5"><button type="submit">Make an Appointment</button></div>
                </form>
