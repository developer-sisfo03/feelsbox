                                ...
                                @else
                                    @foreach($booking as $b)
                                        <tr>
                                            ...
                                            <td>
                                                @if($b->psikolog_id->image != null)
                                                    <img class="myImg" src="{{asset('storage/'.$b->psikolog_id->image)}}" width="100px" height="100px" alt="">]
                                                @else
                                            ...
                                            <td>{{$b->waktu}}</td>
                                            <td>
                                               <a href="{{$b->link}}" class="btn btn-primary">Gmeet</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
